...
class TestElementMethods(unittest.TestCase):
    ...
    def test_invalid_elements(self):
        ...
        self.assertRaises(NotAValidElementException, Element, 'A')
        self.assertRaises(NotAValidElementException, Element, 'AL')
        self.assertRaises(NotAValidElementException, Element, 'Xxx')
